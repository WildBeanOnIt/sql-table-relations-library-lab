INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "The Hunger Game series", 1, 1);
INSERT INTO series (id, title, author_id, subgenre_id) VALUES (2, "The Percy Jackson series", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "Yoda");
INSERT INTO subgenres (id, name) VALUES (2, "Gandalf");

INSERT INTO authors (id, name) VALUES (1, "George R.R. Martin");
INSERT INTO authors (id, name) VALUES (2, "Seanan McGuire");
...
INSERT INTO characters (id, name, species, motto, author_id) VALUES (1, "Lady", "Woof Woof", "direwolf", 1);
...
INSERT INTO characters (id, name, species, motto, author_id) VALUES (8, "Character Four", "motto four", "cylon", 2);
